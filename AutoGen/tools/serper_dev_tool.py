...
class SerperDevTool():
    ...
    def _run(self, search_query:str, search_type:str) -> Dict[str, Any]:
...
def google_search(search_query: str, search_type:str) -> Any:
    '''A tool that can be used to search the internet (Google) with a search_query. Supports two search types: 'search' (default), 'news'.
    '''
    # Sentimal Kernel is picky about the function return type. 
    return SerperDevTool()._run(search_query, search_type)